        ...
        data:[
            {
                ...
                tech: [
                    "pixi.js", "localforage (in-browser storage)", "HTML", "JavaScript", "CSS"
                ],
                description: "2D HTML5 endless fruit collecting game",
                longDescription: "Fruity Duck is a 2D HTML5 progessive web app created with the rendering engine pixi.js.\
                 ...
                 Additionally, I learned about some progressive web app functionalities, giving Fruity Duck an app-like feel on mobile devices.",
            ...
            },
            {
                ...
                tech: [
                    "Flask", "Python", "HTML", "JavaScript", "Bootstrap"
                ],
                description: "Madlibs generator",
                longDescription: "MadLibs is a web application that allows users to create libs using their own words.\
            ...
            },
            {
                ...
                modalRef: "foodyModal",
                tech: [
                    "Clarifai API (image recognition)", "YellowPages API", "Nuance API (speech reconition)", "Python", "HTML", "JavaScript", "CSS", "Bootstrap"
                ],
                description: "Interactive cuisine and restaurant finder",
                longDescription: "Made for ConUHacks 2, Foody is a web app that finds nearby restaurants that serve cuisine based on images you've selected.\
        ...
        data: [
            {
                ...
                tech: [
                    "Native Android", "Java", "natty API (natural language data parser)"
                ],
