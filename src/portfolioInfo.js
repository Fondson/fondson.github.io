...
const portfolioInfo = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        tech: ['pixi.js', 'localforage (in-browser storage)', 'HTML/CSS/JavaScript'],
        description: '2D HTML5 endless fruit collecting game',
        longDescription: {
          __html:
            'Fruity Duck is a 2D HTML5 <b>progessive web app</b> created with the rendering engine <b>pixi.js.</b> \
      ...
      },
      {
        ...
        tech: ['Flask', 'Python', 'HTML/CSS/JavaScript', 'Bootstrap'],
        description: 'Madlibs generator',
        longDescription: {
          __html:
            'MadLibs is a web application that allows users to create libs using their own words. \
      ...
      },
      {
        ...
        longDescription: {
          __html:
            "Made for ConUHacks 2, Foody is a web app that finds nearby restaurants that serve cuisine based on images you've selected.\
    ...
    data: [
      {
        ...
        tech: ['Native Android', 'Java', 'natty API (natural language date parser)'],
        description: 'Note-taking lockscreen replacement',
        longDescription: {
          __html:
            'Give your important reminders the attention they deserve. \
      ...
      },
      {
        ...
        tech: ['Native Android', 'Java', 'Clarifai API (image recognition)'],
        description: 'Game to test images against image recognition technology',
        longDescription: {
          __html:
            'Made for ConUHacks 1 with the visual recognition technology of the Clarifai API,\
    ...
    data: [
      {
        ...
        longDescription: {
          __html:
            'A C# implementation of Connect Four packaged with a challenging AI and various per-game customizations. \
      ...
      },
      {
        ...
        longDescription: {
          __html:
            'Circle The Dot is a game where the player tries to trap the computer by enclosing it with player dots. \
