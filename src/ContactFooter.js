              ...
              <div className="row">
                <div className="footer-col col-md-12">
                  ...
                  <ul className="list-inline">
                    <li>
                      <a
                        href="https://ca.linkedin.com/in/fondson-tran-4a070a109"
                    ...
                    <li>
                      <a href="http://github.com/fondson" className="btn-social btn-outline">
                        <i className="fa fa-fw fa-github"></i>
                      </a>
                    </li>
                    <li>
                      <a
                        onMouseLeave={this.resetEmailCopied}
                      ...
                      <ReactTooltip
                        ...
                        effect="solid"
                        getContent={() =>
                          emailCopied ? 'Copied email address to clipboard' : 'Copy email address'
                        }
